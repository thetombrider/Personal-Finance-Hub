...
import { LayoutDashboard, CreditCard, PieChart, Receipt, Menu, X, Plus, FileSpreadsheet } from "lucide-react";
    ...
    <div className="flex flex-col h-full">
      ...
      <div className="p-4 border-t border-border">
        <div className="bg-card border border-border rounded-xl p-4 shadow-sm">
          <p className="text-xs font-medium text-muted-foreground mb-1">Monthly Budget</p>
          <div className="flex justify-between items-end mb-2">
            <span className="text-sm font-bold text-foreground">€1,250</span>
            <span className="text-xs text-muted-foreground">of €2,000</span>
          </div>
